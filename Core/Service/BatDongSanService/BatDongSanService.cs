...
namespace Core.Service.BatDongSanService
{
    public class BatDongSanService : IBatDongSanService
    {
            ...
            )
        {
            ...
            return query.Where(x => x.TrangThai != TrangThaiBatDongSan.LOCK && x.LoaiBatDongSan != LoaiBatDongSan.KHACHDANG && x.TrangThai!=TrangThaiBatDongSan.DABAN).Select(x => BatDongSanDTO.FromEntity(x));
        }
