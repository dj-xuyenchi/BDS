...
namespace Core.Data
{
    public class BDSContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=LAPTOP-C6TGHIOB\\SQLEXPRESS;Initial Catalog=bds.DB;Integrated Security=True;encrypt=true;trustservercertificate=true;MultipleActiveResultSets=True;");
        }
